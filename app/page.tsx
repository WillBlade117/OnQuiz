        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 animate-in fade-in zoom-in-95 duration-1000 delay-150">
          {THEMES.map((theme) => (
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none opacity-0 transition-opacity rounded-3xl bg-gradient-to-tr from-transparent via-white/10 to-white/20 dark:via-white/5 dark:to-white/10 group-hover:opacity-100"></div>
            </Link>
          ))}
        </div>

        <div className="mt-20 flex flex-col items-center gap-4 border-t border-slate-300/50 dark:border-slate-800/50 pt-12 text-center">
